        ...
        <div className="max-w-[1200px] w-full flex flex-col md:flex-row gap-12 lg:gap-20 justify-between items-center px-6 sm:px-10 z-10 relative">
          ...
          <div className="w-full max-w-[490px] p-8 md:p-12 rounded-[36px] glass-card z-30 select-none shrink-0 self-center border border-border shadow-2xl transition-all duration-500">
            <div ref={chaptersRef} className="w-full h-[440px] relative">
              {/* SCENE 1: Discover */}
              <div className="absolute inset-0 flex flex-col justify-center space-y-6 text-left pointer-events-auto">
                <Typography
                  variant="h2"
                ...
                <Typography
                  variant="body"
                  className="text-muted-foreground text-base md:text-[18px] leading-relaxed"
                >
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  <Link href="/signup" passHref className="w-full sm:w-auto">
                    <Button
                      ...
                      variant="primary"
                      size="lg"
                      className="group text-sm md:text-[18px] py-3.5 px-7 rounded-[16px] w-full flex items-center justify-center gap-2"
                    >
                  ...
                  <Link href="/book-demo" passHref className="w-full sm:w-auto">
                    <Button
                      ...
                      variant="glass"
                      size="lg"
                      className="text-sm md:text-[18px] py-3.5 px-7 rounded-[16px] w-full flex items-center justify-center gap-2"
                    >
                      <span>Book Demo</span>
                    </Button>
                  </Link>
              ...
              {/* SCENE 2: Browse */}
              <div className="absolute inset-0 flex flex-col justify-center space-y-6 text-left opacity-0 pointer-events-none">
                <Typography
                  variant="h3"
